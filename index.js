...
function getArtistByIndex(array) {
  return `the artist at index ${array[0].id} is ${array[0].name}`;
}

console.log('Task 3:', getArtistByIndex(artists));
...
console.log('Task 7:', removeArtist(artists[0]));
...
console.log('Task 8:', artistInfo(artists));
